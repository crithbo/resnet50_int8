...
BUILTIN_SLICE_TYPE_ROUTERS: dict[str, SliceRouter] = {
    # Rule-owned canonical non-interleaved RoPE half pairing:
    # head_dim=128, elements_per_slice=32, half distance=2 slices.
    "rope_slice_xor2": lambda slice_id: slice_id ^ 0b10,
    "slice4": lambda slice_id: slice_id - slice_id % 4,
    # Preserve the generic native strategies byte-for-byte in meaning.
