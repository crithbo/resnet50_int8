...
import tools.validate_node0004_v23_runner_feature_controls as base
...
def write_stubs(stub_root: Path, python: Path) -> None:
    ...
    anchor = (
        ...
        "feature=RETURN_OBS_FINAL_RELEASE enabled=1 "
        "limit_name=RETURN_OBS_FINAL_RELEASE_LIMIT limit=256\n"
    )
    addition = (
        anchor
        + "0 | DIAGNOSTIC_FEATURE_ENABLE_V1 | "
        "feature=RETURN_OBS_DWRITE_PATH enabled=1 "
        "limit_name=RETURN_OBS_DWRITE_PATH_LIMIT limit=64\n"
        + "0 | DIAGNOSTIC_FEATURE_ENABLE_V1 | "
...
def main() -> int:
    ...
    report = base.validate(
        ...
        report_schema="node0004-v29-runner-controls-v1",
