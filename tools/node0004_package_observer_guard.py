...
def observer_precompile_receipt(
    ...
    return {
        "schema": "node0004-package-local-observer-precompile-v1",
        "valid": not errors,
        "errors": errors,
        "package_root": str(root),
        "observer_relative_path": OBSERVER_REL.as_posix(),
        ...
        "xmr_static_gate": {
            ...
            "runtime_indexed_generated_instance_reference_count": len(
                runtime_indexes
            ),
        },
