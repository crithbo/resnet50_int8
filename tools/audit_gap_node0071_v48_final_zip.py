#!/usr/bin/env python3
"""Independent final-ZIP rule self-audit for GAP node0071 v48."""
...
def main() -> int:
    ...
    release_gate_matrix = {
        ...
        "return_result_conjunction": {
            ...
            "evidence":
                "75-item allowlist, 48 formal readbacks, runtime-D absent, "
    ...
    result = {
        "schema": "gap-node0071-v48-final-zip-rule-self-audit-v1",
