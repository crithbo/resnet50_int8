...
Using SCA cfg file: install/cfg_pkg/r5_n71_gap_v48_multislice_pipeline_diag/sca_cfg.json
Using SCA cfg D file: install/cfg_pkg/r5_n71_gap_v48_multislice_pipeline_diag/sca_cfg_D.json
...
def main() -> int:
    ...
    digest = sha(args.zip)
    with tempfile.TemporaryDirectory(prefix="gap-v48-harness-") as temp:
        temp_root = Path(temp)
    ...
    report = {
        "schema": "gap-node0071-v48-runner-harness-v1",
