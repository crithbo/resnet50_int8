...
BUILD_ID = "r5-node0071-node0075-e1fb0f7-native-ordering-package-v4"
...
install_name="r5_n71_n75_e1f_native_v4"
...
def _build_tree(root: Path) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "successor_of": {
            ...
            "workload_config_execplan_sca_golden_changed": False,
        },
        "single_command": (
            "bash PREPARE_AND_RUN.sh /absolute/path/to/NDP_copyXX"
        ),
