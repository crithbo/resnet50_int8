#!/usr/bin/env python3
"""Write the p34b same-epoch shadow build specification."""
...
BASE = "outputs/conv_native_four_lane_0ccae916_p34b_armtoken"
BOUND = "outputs/conv_native_four_lane_0ccae916_p34b_armtoken_source_bound"
...
def main() -> int:
    if OUTPUT.exists():
        raise RuntimeError("refusing to overwrite p34b build specification")
    builder = "tools/build_conv_native_four_lane_0ccae916_p34b_armtoken_package.py"
    family_validator = "tools/validate_conv_native_four_lane_0ccae916_p34b_armtoken_package.py"
    target_parser = "tools/conv_native_four_lane_p34_arm_token_parser.py"
    runner_validator = "tools/validate_conv_native_four_lane_0ccae916_p34b_runner_harness.py"
    generator = "tools/generate_server_source_bound_observer.py"
    generation = f"{BOUND}/source_bound_observer_generation.json"
    source = "artifacts/operator_config_validation/r5-server-test-packages/pending/r5_n4_0cc_p33b_wrowner.zip"
    analysis = "outputs/conv_native_four_lane_0ccae916_p33b_return_analysis/report.json"
    ...
    value = {
        ...
        "rule_change_epoch": {"epoch_id": "20260810-first-fresh-extra-audit-v1", "first_fresh_after_change": False, "prior_audit_receipt": {"path": prior, "sha256": sha(ROOT / prior)}},
        ...
        "inputs": [
            ...
            record(target_parser, "canonical_predicate"), record(f"{BOUND}/arm_token_contract.json", "canonical_predicate"),
            record(post_helper, "return_core_contract"), record(prior, "storage"),
        ],
        "validators": validators, "receipt_reuse_candidates": [], "require_all_cheap_checks": True,
        "cheap_check_reports": [
