#!/usr/bin/env python3
"""Write the one-shot p38 same-epoch shadow build specification."""
...
BASE = "outputs/conv_native_four_lane_0ccae916_p38_mse4join"
BOUND = "outputs/conv_native_four_lane_0ccae916_p38_mse4join_source_bound"
OUTPUT = ROOT / BASE / "server_package_build_spec_v2.json"
EPOCH = "20260811-exact-instance-payload-semantic-fingerprint-v2"
PRIOR = "artifacts/operator_config_validation/r5-server-test-packages/tested/conv_native_four_lane/r5_n4_0cc_p36b_semfp/r5_n4_0cc_p36b_semfp.first_fresh_validation.json"
...
def main() -> int:
    if OUTPUT.exists():
        raise RuntimeError("refusing to overwrite p38 build specification")
    builder = "tools/build_conv_native_four_lane_0ccae916_p38_mse4join_package.py"
    family = "tools/validate_conv_native_four_lane_0ccae916_p38_mse4join_package.py"
    runner = "tools/validate_conv_native_four_lane_0ccae916_p38_runner_harness.py"
    generator = "tools/generate_server_source_bound_observer.py"
    source = "artifacts/operator_config_validation/r5-server-test-packages/pending/r5_n4_0cc_p37b_saepoch.zip"
    analysis = "outputs/conv_native_four_lane_0ccae916_p37b_return_analysis/report.json"
    parser = "tools/conv_native_four_lane_p38_mse4_join_parser.py"
    ...
    value = {
        ...
        "inputs": [
            record(source, "package_identity"),
            record(builder, "package_identity"),
            record(analysis, "return_collector"),
            ...
            record(parser, "canonical_predicate"),
            record(f"{BOUND}/mse4_join_contract.json", "canonical_predicate"),
            record(f"{BOUND}/exact_instance_identity.json", "canonical_predicate"),
            record(helper, "return_core_contract"),
