...
from resnet50_pipeline.gap_node0071_v2_return_analysis import (  # noqa: E402
...
DEFAULT_OUTPUT = (
    ...
    "r5-gap-node0071-v2-return-analysis/report.json"
)
...
def main() -> int:
    ...
    report = analyze_gap_node0071_v2_return(ROOT, args.return_zip)
