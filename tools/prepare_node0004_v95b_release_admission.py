#!/usr/bin/env python3
"""Prepare exact-final-ZIP release admission for locally staged v95b."""
...
CLAIM = "Local staged package release only; no v95 production execution, validated functional root, configuration workaround, natural-terminal, formal-D, E3, E4 or E5 claim."
...
def main() -> int:
    ...
    write_json(release_path, {
        "schema": "node0004-v95b-release-admission-receipt-v1",
    ...
    write_json(failure_path, {
        ...
        "package_id": PACKAGE, "final_zip_sha256": zip_sha,
    ...
    write_json(contract_path, {
        ...
        "package": {
            "package_id": PACKAGE, "family": "conv_serialized_node0004",
            "staging_root": rel(TREE),
            "final_zip": {"path": rel(ZIP), "bytes": ZIP.stat().st_size, "sha256": zip_sha},
            "zip_root_member": PACKAGE, "runner_member": "PREPARE_AND_RUN.sh",
        },
        "manifest": {
            "member": "package_manifest.json", "package_id_pointer": "/package_id",
            "status_pointer": "/status", "ready_status": "PACKAGE_READY_NOT_RUN",
            "nonfinal_status": "PACKAGE_READY_NOT_RUN_LOCAL_BUILD_PENDING_GATES",
        },
        "release_receipt": {
            "path": rel(release_path), "sha256": sha(release_path),
        ...
        "build_receipt_semantics": {
            ...
            "positive_assertions": [
                ...
                {"fact_id": "runtime_v3_interheartbeat_false_freeze_negative_pass", "observed": True, "required": True},
                {"fact_id": "deterministic_final_zip", "observed": True, "required": True},
                {"fact_id": "frozen_operator_payload", "observed": True, "required": True},
                {"fact_id": "direct_config_rtl_dynamic_evidence_policy_bound", "observed": True, "required": True},
            ],
            "negative_observations": [
                ...
                {"fact_id": "configuration_workaround_recommended_before_validation", "observed": False, "required": False},
            ],
            "informational_facts": [
        ...
        "precompile_failure_core": {"path": rel(failure_path), "sha256": sha(failure_path)},
