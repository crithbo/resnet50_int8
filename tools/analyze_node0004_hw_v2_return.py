...
from resnet50_pipeline.node0004_v2_return_analysis import (  # noqa: E402
...
DEFAULT_OUTPUT = (
    ...
    "r5-node0004-hw-v2-return-analysis/report.json"
)
...
def main() -> int:
    ...
    report = analyze_node0004_v2_return(ROOT, args.return_zip)
