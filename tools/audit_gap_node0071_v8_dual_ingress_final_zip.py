...
OUTPUT = (
    ROOT
    / "artifacts/operator_config_validation/r5-server-test-packages"
    / "r5_n71_gap_v8_dual_ingress.final_zip_rule_self_audit.json"
)
ROOT_NAME = "r5_n71_gap_v8_dual_ingress"
RULES = {
...
def audit() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(
        prefix="gap-node0071-v8-final-audit-"
    ) as temporary:
    ...
    rule_checks = {
        "complete_rebuild_or_frozen_reuse": {
            ...
            "reason":
                ...
                "reuse; namespace plus observer-only qualified localization "
                "changed",
        },
    ...
    return {
        ...
        "package_release": {
            ...
            "expected_return": [
                "r5_n71_gap_v8_dual_ingress_return.zip",
                "r5_n71_gap_v8_dual_ingress_return.zip.sha256",
            ],
        },
    }
