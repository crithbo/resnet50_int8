...
def preflight(package_root: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "node0004-hang-localization-preflight-v6",
        "valid": True,
...
def verify_install(package_root: Path, cfg_root: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "node0004-hang-localization-install-v6",
        "valid": True,
...
def analyze(
    ...
    value = {
        "schema": "node0004-hang-localization-result-v6",
...
def collect(
    ...
    allowlist = {
        "schema": "node0004-hang-localization-return-allowlist-v6",
