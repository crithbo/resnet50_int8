...
import tools.validate_node0004_v36_runner_controls as prior  # noqa: E402
...
def write_stubs(stub_root: Path, python: Path) -> None:
    ...
    if text.count(anchor) != 1:
        raise ValueError("safe-stub v37 marker anchor differs")
    make.write_text(
...
def main() -> int:
    ...
    report = base.validate(
        ...
        report_schema="node0004-v37-runner-controls-v1",
