#!/usr/bin/env python3
"""Write the one-shot p37b same-epoch shadow build specification."""
...
BASE = "outputs/conv_native_four_lane_0ccae916_p37b_saepoch"
BOUND = "outputs/conv_native_four_lane_0ccae916_p37b_saepoch_source_bound"
...
def main() -> int:
    if OUTPUT.exists():
        raise RuntimeError("refusing to overwrite p37b build specification")
    builder = "tools/build_conv_native_four_lane_0ccae916_p37b_saepoch_package.py"
    family = "tools/validate_conv_native_four_lane_0ccae916_p37b_saepoch_package.py"
    runner = "tools/validate_conv_native_four_lane_0ccae916_p37b_runner_harness.py"
    generator = "tools/generate_server_source_bound_observer.py"
    source = "artifacts/operator_config_validation/r5-server-test-packages/pending/r5_n4_0cc_p37_saepoch.zip"
    ...
    value = {
        ...
        "inputs": [
            ...
            record(f"{BOUND}/sa_epoch_contract.json", "canonical_predicate"),
