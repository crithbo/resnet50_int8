// node0004 c0 qualified-progress localization extension.
//
    ...
    task automatic return_hang_diag_emit_decision(input string reason);
        ...
        begin
            ...
            if (return_obs_fd != 0) begin
                $fdisplay(
                    return_obs_fd,
                    "%0t | DIAG_DECISION | reason=%s boundary=%s stage=c0 start_comp=1 completed_stages=0 active_cycles=%0d sample=%0d no_progress_windows=%0d consecutive_progress_windows=%0d qualified_progress=%0d req0=%0d req1=%0d req3=%0d rdata0=%0d rdata1=%0d rdata3=%0d buf4_wr_edge=%0d buf4_rd_edge=%0d buf5_wr_edge=%0d buf5_rd_edge=%0d buf4_wr_raw=%0d buf4_rd_raw=%0d buf5_wr_raw=%0d buf5_rd_raw=%0d d_req=%0d d_wdata=%0d slice_finish=%0b",
                    $time,
                    reason,
                    boundary,
