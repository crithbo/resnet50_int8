#!/usr/bin/env python3
"""Stream and summarize the serialized Conv v95b formal return.
...
def main() -> int:
    ...
    report = {
        "schema": "node0004-v95b-tbvcd-return-streaming-analysis-v1",
        ...
        "claim_boundary": "Identity, bounded log attribution, and complete local streaming parse of the exact v95b return; family causal/root adjudication is written separately.",
    ...
    checkpoint = {
        ...
        "kind": "family_v95b_full_causal_stream",
        "sequence": sequence,
    ...
    if '"kind": "family_v95b_full_causal_stream"' not in existing:
    ...
    text = report_path.read_text(encoding="utf-8") if report_path.is_file() else "# Incremental v95b review\n"
