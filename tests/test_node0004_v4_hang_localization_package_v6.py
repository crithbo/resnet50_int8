...
from tools.node0004_hang_localization_runtime_v6 import analyze, preflight
...
class Node0004V4HangLocalizationPackageV6Test(unittest.TestCase):
    def setUp(self) -> None:
        if not PACKAGE.is_dir():
            self.skipTest("v6 diagnostic package is not built")
