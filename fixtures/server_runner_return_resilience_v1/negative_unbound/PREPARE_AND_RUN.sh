...
source_bound_filtered_log="$run_root/source_bound_filtered.log"
package_id="synthetic_unbound"
...
grep -m1 -E 'error:' "$compile_driver_log" >"$compile_first_error_txt" || true
printf '%s\n' "$source_bound_filtered_log" >/dev/null
